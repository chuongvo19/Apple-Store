...
<link rel="stylesheet" href="{{ asset('backend/asset/css/morris.css') }}" type="text/css"/>
<!-- calendar -->
<link rel="stylesheet" href="{{ asset('backend/asset/css/monthly.css') }}">
<!-- //calendar -->
<!-- //font-awesome icons -->
...
<!-- calendar -->
	<script type="text/javascript" src="{{ asset('backend/asset/js/monthly.js') }}"></script>
